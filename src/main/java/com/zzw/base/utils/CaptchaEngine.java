...
public class CaptchaEngine extends ListImageCaptchaEngine
{
    ...
    /** 随机字符 */
    private static final String CHAR_STRING = "ABCDEFGHJKMNPQRSTUVWXYZSZHZZPZXZXZ";

    /** 随机背景图片路径 */
    private static final String BACKGROUND_IMAGE_PATH = SysParamUtils.getString("filesDir") + File.separator +  "captchas"; // 随机背景图片路径
    /**
     * 随机字体
     */
     ...
     */
    @Override
    protected final void buildInitialFactories()
    {
