                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="easyui-textbox" type="text" id="userName" name="userName"
                                           value="${user.userName!''}" disabled="true" 　readOnly="true"
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="easyui-textbox" type="text" name="realName"
                                           value="${user.realName!''}" data-options="required:true"
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <label><input name="gender" type="radio" value="0"
                                                  <#if user.gender=="0">checked="checked"</#if>/>男</label>
                                    <label><input name="gender" type="radio" value="1"
                                                  <#if user.gender=="1">checked="checked"</#if>/>女</label>
