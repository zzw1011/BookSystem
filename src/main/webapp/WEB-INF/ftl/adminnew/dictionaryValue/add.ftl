            ...
            <div class="table_box">
                ...
                <div class="table_con ">
                    <form id="editForm" action="save.do" method="post">
                        <input type="hidden" value="${dictionaryId?c}" name="dictionaryId">
                            ...
                            <tr>
                                ...
                                <td >
                                    <input class="easyui-numberbox" type="text"
                                           name="dicTxt"
                                           validType="number[5]" style="width:500px;"></input>
                                </td>
                            </tr>
...
<script>
    $().ready(function () {
        ...
        $cancelButton.click(function () {
            window.location.href = "list.do?dictionaryId=${dictionaryId?c}";
        });
